  ...
  begin
    ...
    case RecebeOrdem  of
      ...
      begin
        ...
        RLLabel9.Caption := 'Ordenado por código';
      end;
      1:
      begin
    ...
    Open;
    RLLabel11.Caption := ' Período: De: '+DateToStr(ReceData)+'  Até: '+DateToStr(RecebeData2)+'';
...
begin
  ...
  begin
    ...
    RLLabel4.Caption := ' Período: De: '+DateToStr(ReceData)+'  Até: '+DateToStr(RecebeData2)+'';
