  ...
  begin
    case RecebeAcao of
      ...
      begin
        ...
        begin
          if enviaMensagem('Se deseja somente atualizar o nome do Produto selecione "SIM", ou para Modificar seu status "NÃO"','Informação...',mtConfirmation,[mbYes,mbNo])= mrNo then
          begin
            if StrToInt(edEstoque.Text)<= 0 then
            begin
              enviaMensagem('Estoque zerado. produto não pode ser ativado!','Informação...',mtConfirmation,[mbOK]);
